...
_C.MODEL.BACKBONE.FREEZE_AT = 2   # TODO
...
_C.MODEL.ROI_MASK_HEAD.OUTPUTNORM = ""
# Whether to use class agnostic for mask prediction
_C.MODEL.ROI_MASK_HEAD.CLS_AGNOSTIC_MASK = False
# Type of pooling operation applied to the incoming feature map for each RoI
_C.MODEL.ROI_MASK_HEAD.POOLER_TYPE = "ROIAlignV2"
_C.MODEL.ROI_MASK_HEAD.GALA = False
_C.MODEL.ROI_MASK_HEAD.NL = 'softplus'
_C.MODEL.ROI_MASK_HEAD.GRAD = 'cbp'
_C.MODEL.ROI_MASK_HEAD.TIMESTEPS = 0
_C.MODEL.ROI_MASK_HEAD.XI = 1.0
_C.MODEL.ROI_MASK_HEAD.TAU = 0.95
_C.MODEL.ROI_MASK_HEAD.LESS_SOFTPLUS = True
...
# Multiply pretrained weight LR by this scale
_C.SOLVER.PRETRAINED_LR_SCALE = 1.  # 0.01
# List of key wildcards for weights we want to train with full LR
_C.SOLVER.ADDED_WEIGHT_KEYS = []  # ['recurrent', 'topdown']
